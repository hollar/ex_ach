defmodule ExAch.Batch.EntryTest do
  ...
  describe "creating batch entry" do
    test "batch entry created successfully" do
      ...
      {:ok, receiving_dfi_identification} = ReceivingDfiIdentification.new("12345678")
    ...
    test "optional fields get assigned a value" do
      ...
      assert Field.module(batch_entry.identification_number) == Field.Optional
      assert Field.module(batch_entry.discretionary_data) == Field.Optional
    end
  end
end
