defmodule ExAch.Batch.HeaderTest do
  ...
  describe "creating batch header" do
    test "batch header created successfully" do
      ...
      {:ok, company_identification} = CompanyIdentification.new(1112223334)
      ...
      {:ok, batch_number} = BatchNumber.new(1234567)
      {:ok, originating_dfi_identification} = OriginatingDfiIdentification.new(12345678)
      ...
      assert batch_number.content == 1234567
      assert originating_dfi_identification.content == 12345678
